...
- **Markdown + LaTeX рендеринг**: Ответы AI отображаются как красивые изображения с поддержкой Markdown разметки и математических формул
- **Анализ изображений**: Отправляйте фотографии задач, уравнений, диаграмм - AI их проанализирует и решит! (изображения не сохраняются на диск)
- **Пошаговые решения**: AI показывает подробные решения с заголовками, списками, выделением текста и формулами
...
2. AI получает ваш вопрос и генерирует структурированный ответ с Markdown разметкой
3. Ответ AI рендерится в красивое изображение с заголовками, списками, выделением текста и LaTeX формулами
4. Вы получаете изображение с полным решением задачи в удобном формате

**Изображения:**
1. Вы отправляете фотографию задачи, уравнения, диаграммы
2. Изображение отправляется напрямую в AI без сохранения на диск
3. AI анализирует изображение и распознает математические задачи
4. AI решает задачу пошагово с подробными объяснениями
5. Ответ отображается как красивое изображение с решением
