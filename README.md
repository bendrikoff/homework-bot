...
- **Анализ изображений**: Отправляйте фотографии задач, уравнений, диаграмм - AI их проанализирует и решит!
...
2. AI анализирует изображение и распознает математические задачи
3. AI решает задачу пошагово с подробными объяснениями
4. Ответ отображается как красивое изображение с решением
